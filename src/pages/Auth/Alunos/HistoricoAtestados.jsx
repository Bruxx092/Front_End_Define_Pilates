                  ...
                  {atestados.map((atestado) => (
                    ...
                    >
                      <div className="flex items-center space-x-2">
                        <span className={`${atestado.color} text-lg leading-none`}>&bull;</span>
                        <span className="text-gray-700 font-medium">{atestado.date}</span>
                        <span className="text-gray-500 text-sm">{atestado.status}</span>
                      </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg w-full max-w-md p-6 space-y-4 relative overflow-y-auto max-h-[90vh]">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-2">
              ...
              {novaFoto && <span className="text-sm truncate max-w-xs">{novaFoto.name}</span>}
            </div>
