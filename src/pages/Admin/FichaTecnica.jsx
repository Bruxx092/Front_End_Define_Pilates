        ...
        <div className="flex flex-col md:flex-row items-center gap-6 mb-6">
          ...
          <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-y-2 text-gray-700">
            ...
            <div>
              ...
              {/* ✅ Novo campo ESTÚDIO */}
              <p className="text-sm text-gray-500 mt-2">Estúdio</p>
              {editMode ? (
                <input
                  name="estudio"
                ...
                <p className="font-medium">{formState.estudio}</p>
              )}
            </div>
          </div>
        </div>
          ...
          {editMode ? (
            formState.experiencia.map((e, i) => (
              <input
                ...
                value={e}
                onChange={(ev) =>
                  handleArrayChange("experiencia", i, ev.target.value)
                }
                className="w-full border border-gray-300 rounded px-2 py-1 mb-1"
              />
            ))
