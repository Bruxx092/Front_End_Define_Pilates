...
export default function ColaboradoresPage() {
  ...
  // 🔹 Estados para futuro consumo da API
  ...
  // =====================================================================================
  // ✅ Função preparada para chamar a API futuramente (mas usa MOCK por enquanto)
  // =====================================================================================
  async function fetchColaboradores() {
    ...
    try {
      // 🔹 AQUI entrará a chamada da API futuramente:
      // const response = await fetch("http://sua-api.com/colaboradores");
      // if (!response.ok) throw new Error("Erro ao carregar dados.");
      // const data = await response.json();

      // 🔸 POR ENQUANTO → usa MOCK
      const data = mockColaboradores;

      setColaboradores(data);
    } catch (err) {
      console.error(err);
      setError("Não foi possível carregar os colaboradores. Usando mock.");
  ...
  // =====================================================================================
  // ✅ HTML/JSX do componente (completo)
  // =====================================================================================
  return (
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full bg-white border border-gray-200 rounded-lg overflow-hidden">
                <thead className="bg-gray-50 text-left">
                  <tr>
                    <th className="px-4 py-2 text-sm text-gray-600 font-medium">
                      Nome
                    </th>
                    <th className="px-4 py-2 text-sm text-gray-600 font-medium">
                      Modalidade
