  ...
  const MobileMenu = () => (
    <Sheet open={isOpen} onOpenChange={setIsOpen}>
      <Button
        variant="ghost"
        size="icon"
        className="md:hidden fixed top-4 left-4 z-50 text-white shadow-lg h-10 w-10" // Botão maior
            ...
            {menuItems.map((item) => {
              ...
              return (
                <NavLink
                  ...
                  to={item.path}
                  className={({ isActive }) => `
                    w-full flex items-center gap-4 px-4 py-3 mb-2 rounded-lg // Maior espaçamento vertical
                ...
                >
                  {({ isActive }) => (
                    <>
                      ...
                      <span
                        className={`font-normal whitespace-nowrap ${TEXT_SIZE}`}
                      >
                        {item.title} 
                      </span>
                    </>
    ...
    <div className="relative">
      <aside
        className={`
          ...
          } // Sidebar expandida ligeiramente mais larga
          z-40
        `}
        style={{
          backgroundColor: "#406882",
      ...
      <div
        className={`
          ...
          } // Ajuste de posicionamento da faixa para 280px
        `}
        style={{
          width: "20px",
      ...
      >
        <Button
          ...
          className={`
            absolute top-1/2 -translate-y-1/2 -left-5 rounded-full h-10 w-10 // Botão maior (h-10 w-10)
            transition-all duration-300 ease-in-out
          `}
          style={{
            backgroundColor: "#A5C7CB",
